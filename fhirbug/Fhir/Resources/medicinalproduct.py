...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/MedicinalProduct) on 2022-12-14.
...
class MedicinalProduct(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicinalProduct, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class MedicinalProductManufacturingBusinessOperation(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicinalProductManufacturingBusinessOperation, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class MedicinalProductName(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicinalProductName, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class MedicinalProductNameCountryLanguage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicinalProductNameCountryLanguage, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class MedicinalProductNameNamePart(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicinalProductNameNamePart, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class MedicinalProductSpecialDesignation(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicinalProductSpecialDesignation, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
