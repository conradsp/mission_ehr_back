...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/Task) on 2022-12-14.
...
class Task(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(Task, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("status", "status", TaskStatus.str, False, None, True),
...
class TaskInput(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(TaskInput, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class TaskOutput(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(TaskOutput, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class TaskRestriction(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(TaskRestriction, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
try:
    ...
    TaskStatus = sys.modules[__package__ + '.TaskStatus']
try:
    from . import address
except ImportError:
