...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/SubstanceProtein) on 2022-12-14.
...
class SubstanceProtein(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstanceProtein, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SubstanceProteinSubunit(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstanceProteinSubunit, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
