...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/Group) on 2022-12-14.
...
class Group(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(Group, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("type", "type", GroupType.str, False, None, True),
...
class GroupCharacteristic(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(GroupCharacteristic, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class GroupMember(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(GroupMember, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
try:
    ...
    GroupType = sys.modules[__package__ + '.GroupType']
try:
