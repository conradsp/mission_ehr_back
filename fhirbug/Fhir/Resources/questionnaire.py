...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/Questionnaire) on 2022-12-14.
...
class Questionnaire(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("subjectType", "subjectType", ResourceType.str, True, None, False),
...
class QuestionnaireItem(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("type", "type", QuestionnaireItemType.str, False, None, True),
            ("enableWhen", "enableWhen", QuestionnaireItemEnableWhen, True, None, False),
            ("enableBehavior", "enableBehavior", EnableWhenBehavior.str, False, None, False),
...
class QuestionnaireItemAnswerOption(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(QuestionnaireItemAnswerOption, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class QuestionnaireItemEnableWhen(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("operator", "operator", QuestionnaireItemOperator.str, False, None, True),
...
class QuestionnaireItemInitial(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(QuestionnaireItemInitial, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
import sys
try:
    from . import EnableWhenBehavior
except ImportError:
    EnableWhenBehavior = sys.modules[__package__ + '.EnableWhenBehavior']
try:
    from . import PublicationStatus
except ImportError:
    PublicationStatus = sys.modules[__package__ + '.PublicationStatus']
try:
    from . import QuestionnaireItemOperator
except ImportError:
    QuestionnaireItemOperator = sys.modules[__package__ + '.QuestionnaireItemOperator']
try:
    from . import QuestionnaireItemType
except ImportError:
    QuestionnaireItemType = sys.modules[__package__ + '.QuestionnaireItemType']
try:
