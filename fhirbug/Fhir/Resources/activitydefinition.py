...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/ActivityDefinition) on 2022-12-14.
...
class ActivityDefinition(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ActivityDefinition, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("kind", "kind", RequestResourceType.str, False, None, False),
...
class ActivityDefinitionDynamicValue(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ActivityDefinitionDynamicValue, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ActivityDefinitionParticipant(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ActivityDefinitionParticipant, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
try:
    from . import RequestResourceType
except ImportError:
    RequestResourceType = sys.modules[__package__ + '.RequestResourceType']
try:
    from . import age
except ImportError:
