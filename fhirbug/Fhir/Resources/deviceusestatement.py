...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/DeviceUseStatement) on 2022-12-14.
...
class DeviceUseStatement(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("status", "status", DeviceUseStatementStatus.str, False, None, True),
...
import sys
try:
    from . import DeviceUseStatementStatus
except ImportError:
    DeviceUseStatementStatus = sys.modules[__package__ + '.DeviceUseStatementStatus']
try:
