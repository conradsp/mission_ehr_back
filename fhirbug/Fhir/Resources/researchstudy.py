...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/ResearchStudy) on 2022-12-14.
...
class ResearchStudy(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("status", "status", ResearchStudyStatus.str, False, None, True),
...
class ResearchStudyObjective(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ResearchStudyObjective, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
import sys
try:
    from . import ResearchStudyStatus
except ImportError:
    ResearchStudyStatus = sys.modules[__package__ + '.ResearchStudyStatus']
try:
