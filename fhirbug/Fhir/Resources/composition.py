...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/Composition) on 2022-12-14.
...
class Composition(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("status", "status", CompositionStatus.str, False, None, True),
...
class CompositionAttester(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("mode", "mode", CompositionAttestationMode.str, False, None, True),
...
import sys
try:
    from . import CompositionAttestationMode
except ImportError:
    CompositionAttestationMode = sys.modules[__package__ + '.CompositionAttestationMode']
try:
