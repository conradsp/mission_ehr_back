...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/SpecimenDefinition) on 2022-12-14.
...
class SpecimenDefinition(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SpecimenDefinition, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SpecimenDefinitionTypeTested(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SpecimenDefinitionTypeTested, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("preference", "preference", SpecimenContainedPreference.str, False, None, True),
...
class SpecimenDefinitionTypeTestedContainer(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SpecimenDefinitionTypeTestedContainer, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SpecimenDefinitionTypeTestedContainerAdditive(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SpecimenDefinitionTypeTestedContainerAdditive, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SpecimenDefinitionTypeTestedHandling(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SpecimenDefinitionTypeTestedHandling, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
import sys
try:
    from . import SpecimenContainedPreference
except ImportError:
    SpecimenContainedPreference = sys.modules[__package__ + '.SpecimenContainedPreference']
try:
