...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/CoverageEligibilityRequest) on 2022-12-14.
...
class CoverageEligibilityRequest(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(CoverageEligibilityRequest, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("purpose", "purpose", EligibilityRequestPurpose.str, True, None, True),
...
class CoverageEligibilityRequestInsurance(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(CoverageEligibilityRequestInsurance, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class CoverageEligibilityRequestItem(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(CoverageEligibilityRequestItem, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class CoverageEligibilityRequestItemDiagnosis(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(CoverageEligibilityRequestItemDiagnosis, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class CoverageEligibilityRequestSupportingInfo(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(CoverageEligibilityRequestSupportingInfo, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
import sys
try:
    from . import EligibilityRequestPurpose
except ImportError:
    EligibilityRequestPurpose = sys.modules[__package__ + '.EligibilityRequestPurpose']
try:
