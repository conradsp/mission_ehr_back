...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/Observation) on 2022-12-14.
...
class Observation(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(Observation, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ObservationComponent(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ObservationComponent, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ObservationReferenceRange(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ObservationReferenceRange, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
