...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/Appointment) on 2022-12-14.
...
class Appointment(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("status", "status", AppointmentStatus.str, False, None, True),
...
class AppointmentParticipant(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(AppointmentParticipant, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("required", "required", ParticipantRequired.str, False, None, False),
            ("status", "status", ParticipationStatus.str, False, None, True),
...
try:
    ...
    AppointmentStatus = sys.modules[__package__ + '.AppointmentStatus']
try:
    from . import ParticipantRequired
except ImportError:
    ParticipantRequired = sys.modules[__package__ + '.ParticipantRequired']
try:
