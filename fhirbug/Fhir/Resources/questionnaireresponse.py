...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/QuestionnaireResponse) on 2022-12-14.
...
class QuestionnaireResponse(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(QuestionnaireResponse, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("status", "status", QuestionnaireResponseStatus.str, False, None, True),
...
class QuestionnaireResponseItem(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(QuestionnaireResponseItem, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class QuestionnaireResponseItemAnswer(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(QuestionnaireResponseItemAnswer, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
import sys
try:
    from . import QuestionnaireResponseStatus
except ImportError:
    QuestionnaireResponseStatus = sys.modules[__package__ + '.QuestionnaireResponseStatus']
try:
