...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/MedicinalProductIndication) on 2022-12-14.
...
class MedicinalProductIndication(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicinalProductIndication, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class MedicinalProductIndicationOtherTherapy(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicinalProductIndicationOtherTherapy, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
