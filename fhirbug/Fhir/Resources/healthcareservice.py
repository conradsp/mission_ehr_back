...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/HealthcareService) on 2022-12-14.
...
class HealthcareService(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(HealthcareService, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class HealthcareServiceAvailableTime(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(HealthcareServiceAvailableTime, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class HealthcareServiceEligibility(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(HealthcareServiceEligibility, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class HealthcareServiceNotAvailable(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(HealthcareServiceNotAvailable, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
