...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/ResearchElementDefinition) on 2022-12-14.
...
class ResearchElementDefinition(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ResearchElementDefinition, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("type", "type", ResearchElementType.str, False, None, True),
            ("variableType", "variableType", EvidenceVariableType.str, False, None, False),
...
class ResearchElementDefinitionCharacteristic(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ResearchElementDefinitionCharacteristic, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("studyEffectiveGroupMeasure", "studyEffectiveGroupMeasure", GroupMeasure.str, False, None, False),
            ...
            ("participantEffectiveGroupMeasure", "participantEffectiveGroupMeasure", GroupMeasure.str, False, None, False),
        ])
        return js
...
import sys
try:
    from . import EvidenceVariableType
except ImportError:
    EvidenceVariableType = sys.modules[__package__ + '.EvidenceVariableType']
try:
...
try:
    from . import ResearchElementType
except ImportError:
    ResearchElementType = sys.modules[__package__ + '.ResearchElementType']
try:
