...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/NutritionOrder) on 2022-12-14.
...
class NutritionOrder(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(NutritionOrder, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class NutritionOrderEnteralFormula(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(NutritionOrderEnteralFormula, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class NutritionOrderEnteralFormulaAdministration(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(NutritionOrderEnteralFormulaAdministration, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class NutritionOrderOralDiet(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(NutritionOrderOralDiet, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class NutritionOrderOralDietNutrient(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(NutritionOrderOralDietNutrient, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class NutritionOrderOralDietTexture(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(NutritionOrderOralDietTexture, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class NutritionOrderSupplement(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(NutritionOrderSupplement, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
