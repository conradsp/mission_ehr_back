...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/Procedure) on 2022-12-14.
...
class Procedure(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(Procedure, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ProcedureFocalDevice(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ProcedureFocalDevice, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ProcedurePerformer(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ProcedurePerformer, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
