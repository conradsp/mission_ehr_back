...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/Invoice) on 2022-12-14.
...
class Invoice(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(Invoice, self).__init__(jsondict=jsondict, strict=strict, **kwargs)

    def elementProperties(self):
        js = super(Invoice, self).elementProperties()
        js.extend([
            ("identifier", "identifier", identifier.Identifier, True, None, False),
            ("status", "status", InvoiceStatus.str, False, None, True),
...
class InvoiceLineItem(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(InvoiceLineItem, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class InvoiceLineItemPriceComponent(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(InvoiceLineItemPriceComponent, self).__init__(jsondict=jsondict, strict=strict, **kwargs)

    def elementProperties(self):
        js = super(InvoiceLineItemPriceComponent, self).elementProperties()
        js.extend([
            ("type", "type", InvoicePriceComponentType.str, False, None, True),
...
class InvoiceParticipant(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(InvoiceParticipant, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
import sys
try:
    from . import InvoicePriceComponentType
except ImportError:
    InvoicePriceComponentType = sys.modules[__package__ + '.InvoicePriceComponentType']
try:
    from . import InvoiceStatus
except ImportError:
    InvoiceStatus = sys.modules[__package__ + '.InvoiceStatus']
try:
