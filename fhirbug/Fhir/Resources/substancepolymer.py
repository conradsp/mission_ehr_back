...
class SubstancePolymer(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstancePolymer, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SubstancePolymerMonomerSet(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstancePolymerMonomerSet, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SubstancePolymerRepeatRepeatUnit(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstancePolymerRepeatRepeatUnit, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
