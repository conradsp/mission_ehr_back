...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/ProductShelfLife) on 2022-12-14.
...
class ProductShelfLife(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ProductShelfLife, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
