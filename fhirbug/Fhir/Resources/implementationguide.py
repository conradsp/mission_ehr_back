...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/ImplementationGuide) on 2022-12-14.
...
class ImplementationGuide(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuide, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuideDefinition(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideDefinition, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuideDefinitionGrouping(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideDefinitionGrouping, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuideDefinitionPage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideDefinitionPage, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("generation", "generation", GuidePageGeneration.str, False, None, True),
...
class ImplementationGuideDefinitionParameter(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideDefinitionParameter, self).__init__(jsondict=jsondict, strict=strict, **kwargs)

    def elementProperties(self):
        js = super(ImplementationGuideDefinitionParameter, self).elementProperties()
        js.extend([
            ("code", "code", GuideParameterCode.str, False, None, True),
...
class ImplementationGuideDefinitionResource(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideDefinitionResource, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuideDefinitionTemplate(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideDefinitionTemplate, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuideDependsOn(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideDependsOn, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuideGlobal(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideGlobal, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuideManifest(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideManifest, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuideManifestPage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideManifestPage, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ImplementationGuideManifestResource(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ImplementationGuideManifestResource, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
import sys
try:
    from . import GuidePageGeneration
except ImportError:
    GuidePageGeneration = sys.modules[__package__ + '.GuidePageGeneration']
try:
    from . import GuideParameterCode
except ImportError:
    GuideParameterCode = sys.modules[__package__ + '.GuideParameterCode']
try:
