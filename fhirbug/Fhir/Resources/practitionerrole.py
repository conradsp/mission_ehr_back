...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/PractitionerRole) on 2022-12-14.
...
class PractitionerRole(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(PractitionerRole, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class PractitionerRoleAvailableTime(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(PractitionerRoleAvailableTime, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class PractitionerRoleNotAvailable(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(PractitionerRoleNotAvailable, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
