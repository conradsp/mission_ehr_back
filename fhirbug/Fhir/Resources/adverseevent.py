...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/AdverseEvent) on 2022-12-14.
...
class AdverseEvent(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(AdverseEvent, self).__init__(jsondict=jsondict, strict=strict, **kwargs)

    def elementProperties(self):
        js = super(AdverseEvent, self).elementProperties()
        js.extend([
            ("identifier", "identifier", identifier.Identifier, False, None, False),
            ("actuality", "actuality", AdverseEventActuality.str, False, None, True),
...
class AdverseEventSuspectEntity(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(AdverseEventSuspectEntity, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class AdverseEventSuspectEntityCausality(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(AdverseEventSuspectEntityCausality, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
import sys
try:
    from . import AdverseEventActuality
except ImportError:
    AdverseEventActuality = sys.modules[__package__ + '.AdverseEventActuality']
try:
