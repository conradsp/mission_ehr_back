...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/MedicationAdministration) on 2022-12-14.
...
class MedicationAdministration(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicationAdministration, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class MedicationAdministrationDosage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicationAdministrationDosage, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class MedicationAdministrationPerformer(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(MedicationAdministrationPerformer, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
