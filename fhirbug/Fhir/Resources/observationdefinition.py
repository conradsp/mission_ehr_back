...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/ObservationDefinition) on 2022-12-14.
...
class ObservationDefinition(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ObservationDefinition, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("permittedDataType", "permittedDataType", ObservationDataType.str, True, None, False),
...
class ObservationDefinitionQualifiedInterval(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ObservationDefinitionQualifiedInterval, self).__init__(jsondict=jsondict, strict=strict, **kwargs)

    def elementProperties(self):
        js = super(ObservationDefinitionQualifiedInterval, self).elementProperties()
        js.extend([
            ("category", "category", ObservationRangeCategory.str, False, None, False),
...
class ObservationDefinitionQuantitativeDetails(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ObservationDefinitionQuantitativeDetails, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
try:
    from . import ObservationDataType
except ImportError:
    ObservationDataType = sys.modules[__package__ + '.ObservationDataType']
try:
    from . import ObservationRangeCategory
except ImportError:
    ObservationRangeCategory = sys.modules[__package__ + '.ObservationRangeCategory']
try:
