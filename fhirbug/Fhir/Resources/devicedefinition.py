...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/DeviceDefinition) on 2022-12-14.
...
class DeviceDefinition(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DeviceDefinition, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class DeviceDefinitionCapability(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DeviceDefinitionCapability, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class DeviceDefinitionDeviceName(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DeviceDefinitionDeviceName, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class DeviceDefinitionMaterial(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DeviceDefinitionMaterial, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class DeviceDefinitionProperty(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DeviceDefinitionProperty, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class DeviceDefinitionSpecialization(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DeviceDefinitionSpecialization, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class DeviceDefinitionUdiDeviceIdentifier(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(DeviceDefinitionUdiDeviceIdentifier, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
