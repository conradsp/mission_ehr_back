...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/Extension) on 2022-12-14.
...
class Extension(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(Extension, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("valueCodeableReference", "valueCodeableReference", codeablereference.CodeableReference, False, "value", False),
            ...
            ("valueRatioRange", "valueRatioRange", ratiorange.RatioRange, False, "value", False),
