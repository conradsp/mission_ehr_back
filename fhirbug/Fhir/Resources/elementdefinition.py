...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/ElementDefinition) on 2022-12-14.
...
class ElementDefinition(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        self.defaultValueCodeableReference = None
        """ Specified value if missing from instance.
        ...
        self.defaultValueRatioRange = None
        """ Specified value if missing from instance.
        ...
        self.fixedCodeableReference = None
        """ Value must be exactly this.
        Type `CodeableReference` (represented as `dict` in JSON). """
        ...
        self.patternCodeableReference = None
        """ Value must have at least these property values.
        Type `CodeableReference` (represented as `dict` in JSON). """
        ...
        super(ElementDefinition, self).__init__(jsondict=jsondict, strict=strict, **kwargs)

    def elementProperties(self):
        js = super(ElementDefinition, self).elementProperties()
        js.extend([
            ("path", "path", str, False, None, True),
            ("representation", "representation", PropertyRepresentation.str, True, None, False),
            ...
            ("defaultValueCodeableReference", "defaultValueCodeableReference", codeablereference.CodeableReference, False, "defaultValue", False),
            ...
            ("defaultValueRatioRange", "defaultValueRatioRange", ratiorange.RatioRange, False, "defaultValue", False),
            ...
            ("fixedCodeableReference", "fixedCodeableReference", codeablereference.CodeableReference, False, "fixed", False),
            ...
            ("fixedRatioRange", "fixedRatioRange", ratiorange.RatioRange, False, "fixed", False),
            ...
            ("patternCodeableReference", "patternCodeableReference", codeablereference.CodeableReference, False, "pattern", False),
            ...
            ("patternRatioRange", "patternRatioRange", ratiorange.RatioRange, False, "pattern", False),
...
class ElementDefinitionBase(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ElementDefinitionBase, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ElementDefinitionBinding(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ElementDefinitionBinding, self).__init__(jsondict=jsondict, strict=strict, **kwargs)

    def elementProperties(self):
        js = super(ElementDefinitionBinding, self).elementProperties()
        js.extend([
            ("strength", "strength", BindingStrength.str, False, None, True),
...
class ElementDefinitionConstraint(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ElementDefinitionConstraint, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("requirements", "requirements", str, False, None, False),
            ("severity", "severity", ConstraintSeverity.str, False, None, True),
...
class ElementDefinitionExample(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        self.valueCodeableReference = None
        """ Value of Example (one of allowed types).
        Type `CodeableReference` (represented as `dict` in JSON). """
        ...
        super(ElementDefinitionExample, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("valueCodeableReference", "valueCodeableReference", codeablereference.CodeableReference, False, "value", True),
            ...
            ("valueRatioRange", "valueRatioRange", ratiorange.RatioRange, False, "value", True),
...
class ElementDefinitionMapping(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ElementDefinitionMapping, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ElementDefinitionSlicing(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ElementDefinitionSlicing, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("rules", "rules", SlicingRules.str, False, None, True),
        ])
        return js
...
class ElementDefinitionSlicingDiscriminator(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ElementDefinitionSlicingDiscriminator, self).__init__(jsondict=jsondict, strict=strict, **kwargs)

    def elementProperties(self):
        js = super(ElementDefinitionSlicingDiscriminator, self).elementProperties()
        js.extend([
            ("type", "type", DiscriminatorType.str, False, None, True),
            ("path", "path", str, False, None, True),
        ])
        return js
...
class ElementDefinitionType(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ElementDefinitionType, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("aggregation", "aggregation", AggregationMode.str, True, None, False),
            ("versioning", "versioning", ReferenceVersionRules.str, False, None, False),
        ])
        return js
...
import sys
try:
    from . import AggregationMode
except ImportError:
    AggregationMode = sys.modules[__package__ + '.AggregationMode']
try:
    from . import BindingStrength
except ImportError:
    BindingStrength = sys.modules[__package__ + '.BindingStrength']
try:
    from . import ConstraintSeverity
except ImportError:
    ConstraintSeverity = sys.modules[__package__ + '.ConstraintSeverity']
try:
    from . import DiscriminatorType
except ImportError:
    DiscriminatorType = sys.modules[__package__ + '.DiscriminatorType']
try:
    from . import PropertyRepresentation
except ImportError:
    PropertyRepresentation = sys.modules[__package__ + '.PropertyRepresentation']
try:
    from . import ReferenceVersionRules
except ImportError:
    ReferenceVersionRules = sys.modules[__package__ + '.ReferenceVersionRules']
try:
    from . import SlicingRules
except ImportError:
    SlicingRules = sys.modules[__package__ + '.SlicingRules']
try:
    from . import address
except ImportError:
