...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/Condition) on 2022-12-14.
...
class Condition(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(Condition, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ConditionEvidence(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ConditionEvidence, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class ConditionStage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(ConditionStage, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
