...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.3.0 (http://hl7.org/fhir/StructureDefinition/CodeSystem) on 2022-12-14.
...
class CodeSystem(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("hierarchyMeaning", "hierarchyMeaning", CodeSystemHierarchyMeaning.str, False, None, False),
            ("compositional", "compositional", bool, False, None, False),
            ("versionNeeded", "versionNeeded", bool, False, None, False),
            ("content", "content", CodeSystemContentMode.str, False, None, True),
...
class CodeSystemFilter(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("code", "code", str, False, None, True),
            ("description", "description", str, False, None, False),
            ("operator", "operator", FilterOperator.str, True, None, True),
            ("value", "value", str, False, None, True),
        ])
        return js
...
class CodeSystemProperty(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("description", "description", str, False, None, False),
            ("type", "type", PropertyType.str, False, None, True),
        ])
        return js
...
import sys
try:
    from . import CodeSystemContentMode
except ImportError:
    CodeSystemContentMode = sys.modules[__package__ + '.CodeSystemContentMode']
try:
    from . import CodeSystemHierarchyMeaning
except ImportError:
    CodeSystemHierarchyMeaning = sys.modules[__package__ + '.CodeSystemHierarchyMeaning']
try:
...
try:
    ...
    PropertyType = sys.modules[__package__ + '.PropertyType']
try:
