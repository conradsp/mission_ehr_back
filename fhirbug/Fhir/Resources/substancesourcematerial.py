...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/SubstanceSourceMaterial) on 2022-12-14.
...
class SubstanceSourceMaterial(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstanceSourceMaterial, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SubstanceSourceMaterialFractionDescription(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstanceSourceMaterialFractionDescription, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SubstanceSourceMaterialOrganism(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstanceSourceMaterialOrganism, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SubstanceSourceMaterialOrganismAuthor(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstanceSourceMaterialOrganismAuthor, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SubstanceSourceMaterialOrganismHybrid(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstanceSourceMaterialOrganismHybrid, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SubstanceSourceMaterialOrganismOrganismGeneral(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstanceSourceMaterialOrganismOrganismGeneral, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
...
class SubstanceSourceMaterialPartDescription(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True, **kwargs):
        ...
        super(SubstanceSourceMaterialPartDescription, self).__init__(jsondict=jsondict, strict=strict, **kwargs)
